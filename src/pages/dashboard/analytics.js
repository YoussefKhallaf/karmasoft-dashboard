...
import AllSalesCard from 'components/cards/statistics/AllSalesCard';
  ...
  return (
    <>
      <Grid container rowSpacing={4.5} columnSpacing={1}>
        ...
        <Grid container rowSpacing={4.5} columnSpacing={3} wrap="nowrap">
          <Grid item xs={12} sm={6} md={4} lg={3}>
            <AnalyticsDataCard title="Best Selling Package" item="Month Unlimited" count="78,250" />
          </Grid>
          <Grid item xs={12} sm={6} md={4} lg={3}>
            <AnalyticsDataCard title="Best Performing Class" item="Hot Vinyasa - Friday 10..." count="18,800" color="warning" />
          </Grid>
          <Grid item>
            <AllSalesCard
              title1="In App"
          ...
          <Grid item xs={12} sm={6} md={4} lg={3}>
            <AnalyticsDataCard title="Best Class Attended" item="Hatha - Sat 1PM" count="250" />
          </Grid>
